...
$sql = "SELECT   email, `name`, title, institution, position, office_number, official_email, 
        phone,workshop, abstract,  exhibitor, upload_request_invoice, upload_filled_in_form,
        ...
        registration_desk_arrival, do_you_have_payment_proof, upload_pop,Timestamp,created_at FROM users WHERE name LIKE ? OR email LIKE ? LIMIT ?, ?";
